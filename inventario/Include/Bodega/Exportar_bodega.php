    <div id="x" class="btn-group mb-3 my-1 mx-2" role="group" aria-label="Basic outlined example" style="position: initial;">
       <form  method="POST" class="mx-1 c" action="../../Plugin/Imprimir/Vale/soli_vale.php" target="_blank">
...
<form  style="margin-left: 2.6%;" method="POST" action="../../Plugin/Excel/Vale/Excel.php" class="mr-1 c">
    <?php if ($tipo_usuario==2) {?>
        <input type="hidden" name="idusuario" value="<?php echo $idusuario ?>">
        <button  data-toggle="tooltip" data-placement="top" title="Exportar en Excel" type="submit" class="btn btn-outline-primary" name="vale1" target="_blank">
            <svg class="bi" width="20" height="20" fill="currentColor">
...
<form method="POST" action="form_bodega_varios.php" >
