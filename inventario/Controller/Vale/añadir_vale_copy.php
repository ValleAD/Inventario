    ...
    if(isset($_POST['detalle_vale'])){
     ...
     if ($estado=='Aprobado') {
      ...
      for($i = 0; $i < count($_POST['cod_vale']); $i++)
      {
          ...
          $mes              = $_POST['mes'];
          $año              = $_POST['año'];
          $update="UPDATE detalle_vale SET stock='$total', cantidad_despachada ='$cantidad_despachada' WHERE codigodetallevale ='$cod_vale'";
          ...
          if (mysqli_num_rows($verificar)>0) {
              ...
              $sql2="UPDATE historial SET Salidas='$cantidad_despachada' WHERE Concepto='Vale Consulta Externa' and idusuario='$idusuario' and Entradas='$total' AND Saldo='$precio' and descripcion='$descripcion' and No_Comprovante='$codigo' and Detalles='$nSolicitud'  and No_Comprovante='$codigo'";
