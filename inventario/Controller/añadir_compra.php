...
for($i = 0; $i < count($_POST['cod']); $i++)
    {
      ...
      $insert = "INSERT INTO tb_compra (codProductos, catalogo, descripcion, unidad_medida, stock, precio) VALUES ('$codigo_producto','$catalogo', '$Descripción', '$u_m', '$cantidad', '$cost')";
