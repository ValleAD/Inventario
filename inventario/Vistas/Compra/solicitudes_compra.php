...
<section id="section" class="mx-3 p-2" style="background-color:white; border-radius:5px;margin-bottom: 3%;"> 
    ...
    <form method="POST" action="form_compra1.php"  >
     <button  data-toggle="tooltip" data-placement="top" title="Nueva solicitud" style="position: initial;font-size: 13px;" type="submit" class="btn btn-outline-primary" name="vale1" target="_blank">➕</button>
 </form>
