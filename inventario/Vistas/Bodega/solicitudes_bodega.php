...
<section id="section" class="mx-3 p-2" style="background-color:white; border-radius:5px;margin-bottom: 3%;"> 
    ...
    <?php if ($tipo_usuario==1) {
        ...
        <div id="x" style="position: initial;" class="btn-group mb-3 my-1 mx-2" style="position: initial;" role="group" aria-label="Basic outlined example">
         <form  method="POST" action="../../Plugin/Imprimir/Bodega/soli_bodega.php" target="_blank" class="c">
        ...
        <form  method="POST" action="../../Plugin/PDF/Bodega/pdf_soli_bodega.php" class="mx-1 c" target="_blank">
    ...
    <form  method="POST" action="../../Plugin/Excel/Bodega/Excel.php" target="_blank" class="c">
...
<?php }else{ ?>
 <div  id="x" class="btn-group mb-3 my-1 mx-2" role="group" aria-label="Basic outlined example" style="position: initial;">
     <form   method="POST" class="mx-1" action="../../Plugin/Imprimir/Bodega/soli_bodega.php" target="_blank" class="c">
    ...
    <form   class="mx-1 c"  method="POST" action="../../Plugin/PDF/Bodega/pdf_soli_bodega.php" target="_blank">
     <?php $sql = "SELECT * FROM tb_bodega WHERE idusuario='$idusuario'";
     $result = mysqli_query($conn, $sql);
     $n=0;
     while ($datos_sol = mysqli_fetch_array($result)){?>
...
<form   class="c"  method="POST" action="../../Plugin/Excel/Bodega/Excel.php">
 <?php $sql = "SELECT * FROM tb_bodega WHERE idusuario='$idusuario'";
 $result = mysqli_query($conn, $sql);
 $n=0;
 while ($datos_sol = mysqli_fetch_array($result)){?>
