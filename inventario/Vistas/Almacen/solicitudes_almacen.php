...
<?php if ($tipo_usuario==1) {?>
    <?php include ('../../Buscador_ajax/Cabezeras/cabezeraAlmacen.php') ?>
         ...
         <form method="POST" action=" ../../Plugin/PDF/Almacen/pdf_soli_almacen.php" id="ssas" target="_blank">
             <button style="position: initial;" type="submit" class="btn btn-outline-primary"  target="_blank" name="id">
                ...
                <use xlink:href=" ../../Plugin/bootstrap-icons-1.8.1/bootstrap-icons.svg#file-pdf-fill"/>
                 ...
                 <form id="ssas" style="margin-left: 2.6%;" method="POST" action="../../Plugin/Excel/Almacen/Excel.php" target="_blank">
...
<?php } ?>
<?php include ('../../Buscador_ajax/Tablas/Almacen/tablaAlmacen.php') ?>
        <div id="x">
