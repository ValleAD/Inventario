...
if(isset($_POST['detalle'])){
    ...
    $cod_vale = $_POST['id'];
     ...
     if ($productos1['departamento']=="") {
    $des = "Sin Departamento";
        
    }else{
    $des = $productos1['departamento'];
      }
     echo'   
              ...
              <input <?php
                if($productos1['estado']=='Pendiente') {
                    echo ' style="background-color:green ;position: initial;width:70%; border-radius:5px;text-align:center; color: white;"';
                     ...
                     echo ' style="background:red;color:white ;style="position: initial;width:70%; border-radius:5px;text-align:center; color: white;"';
                }
...
if(isset($_POST['submit'])){
    ...
    <section>
            ...
            <a type="hidden" onclick="return confirmaion2()" href="../../Controller/Vale/añadir_vale_copy.php?vale=<?php echo $productos1['codVale']?>&estado1=Rechazado"> <label id="label2" for="input1"> Rechazado</label> </a>
          </div>
            </div>
<br>
