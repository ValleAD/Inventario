...
<head>
    ...
    <title>Detalles Circulante</title>
</head>
<body>
    <style>  
        ...
        @media (max-width: 800px){
            ...
            <section id="section" class="section">
                ...
                $sql = "SELECT * FROM tb_circulante WHERE codCirculante = '$cod_compra'";
...
<?php if(isset($_POST['submit'])){
    ...
    $sql = "SELECT * FROM tb_circulante WHERE codCirculante = $cod_vale";
    $result = mysqli_query($conn, $sql);
    while ($productos1 = mysqli_fetch_array($result)){
        ...
        <input readonly class="form-control"  type="hidden" value="' .$productos1['departamento']. '" name="codCirculante">
        <p>' .$productos1['departamento']. '</p>
        </div>

        <div class="col-md-3" style="position: initial">
        <label style="font-weight: bold;">N° de O.D.T.</label>
        <input readonly class="form-control"  type="hidden" value="' .$productos1['codCirculante']. '" name="vale">
        <p>' .$productos1['codCirculante']. '</p>
        </div>
...
<input type="hidden" readonly class="form-control"  type="text" value="<?php echo $productos1['codCirculante']?>" name="vale">
              ...
              <tbody>
                 ...
                 while ($productos = mysqli_fetch_array($result)){
                  ...
                  <tr>
                    ...
                    <input type="hidden"  name="tb_circulante" readonly value="<?php echo $num_vale ?>">
...
<div class="col-md-3 " >
    <div class="card">
        <div class="card-body">
          ...
          <a class="btn btn-outline-primary mb-3" type="hidden" onclick="return confirmaion2()" href="../../Controller/Vale/añadir_vale_copy.php?vale=<?php echo $productos1['codCirculante']?>&estado=Rechazado">Rechazar Producto</a> 
  ...
  <div class="card">
    <div class="card-body">
      ...
      <button id="buscar1" type="submit" class="btn btn-lg btn-success" style="width: 49%;float: left; margin-right: 1%;font-size: 1.4em; text-align: center;" name="Detalle_circulante">Guardar</button>
  </form>
