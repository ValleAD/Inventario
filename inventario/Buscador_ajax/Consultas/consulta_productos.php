...
<div style="position:initial" class="btn-group mb-3 mx-2"  role="group" aria-label="Basic outlined example">
            <form id="form1" style="  method="POST" action="../../Plugin/Imprimir/Producto/productos.php" target="_blank">';
...
echo'             
...
} else
	{
		...
		$tabla="<style>#OcultarDiv{display:none}</style><h1 class=' text-center bg-danger my-4' style='font-size:1.5em; padding:3%; border-radius:5px;color :white;'>No se encontraron coincidencias con sus criterios de búsqueda. <a href='' style='font-size: 30px' class='close'>&times;</a></h1> ";
	}
