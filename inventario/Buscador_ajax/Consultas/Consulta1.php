...
<div id="div" style = " max-height: 442px;  overflow-y:scroll;overflow-x:none;">
    ...
    <tbody><?php 
        $sql = "SELECT cod,codProductos, categoria, catalogo, descripcion, unidad_medida, SUM(stock), precio, fecha_registro FROM tb_productos WHERE stock!=0 GROUP BY precio, codProductos Order by $columna $tipo";
