    <?php
        ...
        <?php include ('../../Model/conexion.php');
            ...
            $tabla="";
            $query="SELECT codCirculante FROM tb_circulante";
            ...
            if(isset($_POST['consulta']))
            {
                ...
                $query="SELECT codCirculante FROM tb_circulante  WHERE 
                codCirculante LIKE '%".$q."%' GROUP BY codCirculante HAVING COUNT(*) ORDER BY codCirculante desc ";
                $result = mysqli_query($conn, $query);
                while ($productos = mysqli_fetch_array($result)){
                    $codigo=$productos['codCirculante'];
