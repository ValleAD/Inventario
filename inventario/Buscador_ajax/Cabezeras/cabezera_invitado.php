 ...
 <div class="col-md-3 mb-2"style="position: initial;" >
            ...
            <input  type="number" name="busqueda" class="form-control" style="float: left;"  id="busqueda" placeholder="Buscar el Código ó Descripción">
...
{
    $.ajax({
        url : '../../Buscador_ajax/Consultas/Consulta_invitado.php',
        type : 'POST',
        dataType : 'html',
