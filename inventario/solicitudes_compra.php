...
echo "<center><a id='cb' href='solicitudes_compra.php?pagina= 1'>".'Primera'."</a>";
for ($i=1; $i <=$total_pagina; $i++) { 
    echo "<a id='c' href='solicitudes_compra.php?pagina=".$i."'>".$i."</a>";
}
echo "<a  id='cbq' href='solicitudes_compra.php?pagina=$total_pagina'>".'Ultima'."</a></center>";
?>
