                            ...
                            <div class="card-body">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6" style="position: initial">
                                   ...
                                   <input class="form-control" type="text" autocomplete="off"  name="Apellido" id="apellido" >
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        if(unidad==""){
           ...
           Toast.fire({
            icon: 'info',
            title: 'Debe de Ingrear el Departamento o Unidad',

        })
        var limpiar = document.getElementById('Unidad'); limpiar.value = "" 
