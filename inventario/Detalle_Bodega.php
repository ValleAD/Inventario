...
$id = $_GET['id'];
$sql = "SELECT * FROM tb_bodega WHERE codBodega='$id'";
if($result= mysqli_query($conn,$sql)){
if (mysqli_num_rows($result)>0) {

	while ($row = mysqli_fetch_array($result)) {
		$codigo = $row['codBodega'];
 ...
 <table class="table">
        ...
        <thead>
 			 ...
 			 <th class="table-info text-dark"><strong>Código</strong></th>
                ...
                <th class="table-info text-dark"><strong>Persona que lo solicito</strong></th>
 	...
 	<tbody>
 		...
 		<td data-label="Persona que lo solicito"><?php echo $usuario ?></td>
