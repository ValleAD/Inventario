...
<a class="btn btn-success mx-2" href="reporte_productos.php?productos">Ver Productos</a>
<?php } 
if (isset($_POST['Fecha'])){  ?>
<a class="btn btn-success mx-2" href="reporte_productos.php?productos">Ver Productos</a>
<?php } ?>
<div class=" row">
<form method="POST" action="reporte_productos.php" style="margin-left: 2%;">
                 <div class="row">
 ...
 <form method="POST" action="reporte_productos.php" style="margin-left: 70%;margin-top: -3%;">  
                 <div class="row">
