...
<body>
    ...
    $sql = "SELECT descripcion,Concepto,unidad_medida,fecha_registro,No_Comprovante,Entradas,Salidas,Saldo FROM historial WHERE fecha_registro BETWEEN ' $f1' AND ' $f2' or No_Comprovante='$Busqueda'";
...
<div class="card">
    <div class="card-body">
        <h6>Stock Por Mes</h6>
        <?php $sql="SELECT Mes,SUM(stock) FROM tb_productos WHERE codProductos LIKE '%".$cod."%' or descripcion LIKE '%".$cod."%'  GROUP BY Mes;";
        $result = mysqli_query($conn, $sql);
        while ($productos = mysqli_fetch_array($result)){
            $mes=$productos['Mes'];
...
<div class="card">
    <div class="card-body">
        <h6> Stock Por Año</h6>
        <?php $sql="SELECT año,SUM(stock) FROM tb_productos WHERE codProductos LIKE '%".$cod."%' or descripcion LIKE '%".$cod."%'  GROUP BY año;";
        $result = mysqli_query($conn, $sql);
        while ($productos = mysqli_fetch_array($result)){
