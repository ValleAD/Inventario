...
<div id="a">
    <div id="t">
        <?php $sql = "SELECT * FROM tb_circulante db JOIN detalle_circulante b ON db.codCirculante = b.tb_circulante WHERE tb_circulante=$vale";
    $result = mysqli_query($conn, $sql);
$n=0;
while ($productos = mysqli_fetch_array($result)){
    ...
    $total = $productos['cantidad_despachada'] * $productos['precio'];
     ...
     <?php } ?>
                  ...
                  <p id="p" align="right"><b style="float: left;">C. Soli. - C. Despa.: </b><?php echo $final7 ?></p>
