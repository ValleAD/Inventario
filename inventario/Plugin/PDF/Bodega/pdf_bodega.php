...
<body style="font-family: sans-serif;">
    ...
    $final8 = "0.00";
    $final9 = "0.00";
    $sql = "SELECT  * FROM  `tb_bodega` WHERE codBodega='$vale' limit 1";
    ...
    <table style="width: 100%;margin: 0;">
        <tr>
            ...
            <td align="right"><b>N° de Bodega.: </b> <?php echo $vale ?></td>
        </tr>
        <tr>
   ...
   <table class="table" style="width: 100%">
    ...
    <tbody>
        <?php 
        $sql = "SELECT   codigo,SUM(stock),SUM(cantidad_despachada),precio,descripcion,unidad_medida  FROM `detalle_bodega` D JOIN `tb_bodega` V ON D.odt_bodega=V.codBodega WHERE odt_bodega = $vale Group by codigo ";
