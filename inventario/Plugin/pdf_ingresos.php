    ...
    <table style="width: 100%; border: 1px solid #ccc;border-collapse: collapse;">
        <thead>     
            <tr style="border: 1px solid #ddd;color: black;">
                ...
                <th style="font-size: 14px;width: 50%;color:black;text-align: left;">Descripción Completa</th>
                ...
                <th style="font-size: 14px;width: 20%;color:black;border-right:1px solid #ccc ;">Fecha</th>
