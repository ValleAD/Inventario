...
if (isset($_POST['vale'])) {
    ...
    $sql1="SELECT Mes,SUM(stock),idusuario FROM tb_vale db JOIN detalle_vale b ON db.codVale = b.numero_vale WHERE db.idusuario='$idusuario'  GROUP by Mes";
}
...
if (isset($_POST['vale'])) {
    ...
    $sql2="SELECT Año,SUM(stock) FROM `detalle_vale` D JOIN `tb_vale` V ON D.numero_vale=V.codVale GROUP by Año;";
}if (isset($_POST['vale1'])) {

    $sql2="SELECT Año,SUM(stock) FROM tb_vale db JOIN detalle_vale b ON db.codVale = b.numero_vale WHERE db.idusuario='$idusuario'  GROUP by Año";
}
