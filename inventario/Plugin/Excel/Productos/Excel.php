...
$sql1="SELECT Mes,SUM(stock) FROM tb_productos   GROUP by Mes;";
...
$sheet->setCellValue('A'.$fila +10, "STOCK POR MES:");
    $spreadsheet->getActiveSheet()->mergeCells('A'.$fila+ 10 .':H'.$fila + 10);

$sql2="SELECT Año,SUM(stock) FROM tb_productos   GROUP by Año;";
